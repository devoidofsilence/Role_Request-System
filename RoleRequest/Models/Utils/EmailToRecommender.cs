...
{
    public class EmailToRecommender
    {
        ...
        public string Body(string UserName)
        {
            ...
            tmpMessage += "A Role Request has been made keeping you as the recommender by: <b>" + UserName + "</b>. Please check the details in the Role Request Application.<br><br>";
